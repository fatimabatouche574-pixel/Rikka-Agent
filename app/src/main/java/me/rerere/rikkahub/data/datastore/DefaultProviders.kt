...
val DEFAULT_PROVIDERS = listOf(
    ...
    ProviderSetting.OpenAI(
        ...
        shortDescription = {
            Text(stringResource(R.string.aihubmix_short_description))
        },
    ),
    ProviderSetting.OpenAI(
    ...
    ProviderSetting.OpenAI(
        ...
        description = {
            MarkdownBlock(
                content = stringResource(R.string.xiaoma_description)
            )
        }
    ),
    ProviderSetting.OpenAI(
    ...
    ProviderSetting.OpenAI(
        ...
        description = {
            MarkdownBlock(
                content = stringResource(R.string.provider_302ai_description)
            )
        }
    ),
    ProviderSetting.OpenAI(
    ...
    ProviderSetting.OpenAI(
        ...
        shortDescription = {
            Text(stringResource(R.string.suixiang_short_description))
        },
    ),
    ...
    ProviderSetting.OpenAI(
        ...
        description = {
            MarkdownBlock(
                content = stringResource(R.string.ackai_description)
            )
        }
    ),
    ProviderSetting.OpenAI(
        ...
        description = {
            MarkdownBlock(
                content = stringResource(R.string.unifyllm_description)
            )
        }
    ),
